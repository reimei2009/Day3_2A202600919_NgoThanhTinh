...
print("✅ Created chatbot.py")

with open('src/agent/react_agent.py', 'w') as f:
    f.write(react_agent_code)
print("✅ Created src/agent/react_agent.py")

# Update agent.py to use the new implementation
agent_wrapper = '''"""
Agent Module
Main entry point for ReAct agent.
"""

from .react_agent import ReActTravelAgent

__all__ = ['ReActTravelAgent']
'''

with open('src/agent/__init__.py', 'w') as f:
    f.write(agent_wrapper)
print("✅ Created src/agent/__init__.py")

print("\\n🎉 Chatbot baseline and ReAct agent created successfully!")